...
**Status:** In Progress - Expanded to build, run, test, clean, clippy, fmt. Reorganized into `src/cmd/` with one file per command. Remaining: Compare, Install, Ts, Version.
