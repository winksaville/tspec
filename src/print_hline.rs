...
macro_rules! print_hline {
    () => { $crate::print_hline::print_hline_impl($crate::print_hline::LINE_WIDTH, $crate::print_hline::LINE_CHAR) };
    ($width:expr) => { $crate::print_hline::print_hline_impl($width, $crate::print_hline::LINE_CHAR) };
